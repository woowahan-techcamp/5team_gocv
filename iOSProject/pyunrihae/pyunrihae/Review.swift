...
class Review {
    ...
    init(id : String, image : String, user : String, product_key : String, timestamp : String, brand : String, category : String, grade : Int, price : Int, flavor : Int, quantity : Int, useful : Int, bad :Int ){
        self.id = id
        self.image = image
        self.user = user
    ...
    convenience init(snapshot : DataSnapshot){
        ...
        self.init(id: id,image : image, user: user, product_key: product_key, timestamp : timestamp, brand: brand, category: category, grade: grade, price : price, flavor: flavor, quantity : quantity, useful: useful, bad : bad)
    }
}
